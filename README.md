...
You will need to install the following Python modules: [time](https://docs.python.org/2/library/time.html) and [selenium](https://pypi.python.org/pypi/selenium); both are installed using `pip`.

Clone the [beeminderpy.py](https://github.com/mattjoyce/beeminderpy/blob/master/beeminderpy.py) file and put it in the same directory as FitBee.py. 
